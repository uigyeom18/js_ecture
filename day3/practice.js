...
//prop() : form 요소(select, checkbox, radio)의 상태 속성값을 가져 올 때
//prop("checked",true) : form요소의 상태 속성 값을 업데이트 할 때

$("input").prop("checked") // -> 만약 체크된 상태면 true 아니면 false
$("input").prop("checked",true) // -> 체크 상태를 true로! 체크 표시
$("input").prop("dfaultValue") // -> 요소의 초기 value 속성 값
